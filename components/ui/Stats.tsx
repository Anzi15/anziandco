    ...
    <section className="py-10 sm:py-12 md:py-16 px-4 bg-gray-50 rounded-xl sm:rounded-2xl md:rounded-3xl">
      <div className="max-w-6xl mx-auto" ref={containerRef}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-4 lg:gap-8">
          <StatCircle percentage={37} description="Average increase in sales for our clients" delay={0.2} />

          <StatCircle percentage={100} description="Google and Facebook-certified team" delay={0.4} />

          <StatCircle percentage={81} description="Results improved compared to previous agencies" delay={0.6} />
