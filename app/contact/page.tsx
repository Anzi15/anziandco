            ...
            <div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 mt-1">(123) 456-7890</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 mt-1">info@anziandco.com</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 mt-1">123 Marketing St, Digital City, 10001</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 mt-1">Mon-Fri: 9AM - 5PM</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <Link href="#" className="p-2 bg-secondary rounded-full hover:bg-primary/10 transition-colors">
          ...
          <div className="relative w-full h-[400px] rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-white p-4 rounded-lg shadow-lg max-w-xs">
                ...
                <p className="text-sm text-gray-500">123 Marketing St, Digital City, 10001</p>
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row mt-4">
              ...
              <Button asChild size="lg" variant="outline" className="text-white border-white hover:bg-white/10">
                <Link href="mailto:info@anziandco.com">Email Us</Link>
              </Button>
            </div>
          </div>
        </div>
